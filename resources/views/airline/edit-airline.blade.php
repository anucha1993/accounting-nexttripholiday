...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{route('airline.update',$airlineModel->id)}}" method="post">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-md-6">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="code" value="{{ $airlineModel->code }}"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="code1" value="{{ $airlineModel->code1 }}"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="travel_name" value="{{ $airlineModel->travel_name }}"
                            required>
                    </div>
                </div>
                <br>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input success" type="radio" {{$airlineModel->status === 'on'? 'checked' : ''}} name="status" id="success-radio" value="on">
                        <label class="form-check-label" for="success-radio">เปิดใช้งาน</label>
                      </div>
                      <div class="form-check form-check-inline">
                        <input class="form-check-input success" type="radio" {{$airlineModel->status === 'off'? 'checked' : ''}} name="status" id="success2-radio" value="off">

        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('users.update', $user->id) }}" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="name" class="col-md-4 col-form-label text-md-end text-start">ชื่อ-นามสกุล</label>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <select name="status" class="form-select" >
                                ...
                                <option @if($user->status === 'enable') selected @endif value="enable">เปิดใช้งาน</option>
                                <option  @if($user->status === 'disable') selected @endif value="disable">ปิดใช้งาน</option>
                            </select>
                        </div>

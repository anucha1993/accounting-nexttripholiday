...
@endif 
     ...
     <div class="text-customer">
        @if ($WithholdingTaxDocument->quote_id != NULL)
            {{ $WithholdingTaxDocument->wholesale->wholesale_name_th }}
        @else
            {{ $WithholdingTaxDocument->customer->customer_name }}
        @endif
    ...
    <div class="text-customer-tax">
        ...
        <span class="group1"><b>{{ substr($WithholdingTaxDocument->wholesale->textid, 0, 1) }}</b></span>
        <span class="group2"><b>{{ substr($WithholdingTaxDocument->wholesale->textid, 1, 4) }}</b></span>
        <span class="group3"><b>{{ substr($WithholdingTaxDocument->wholesale->textid, 5, 5) }}</b></span>
        <span class="group4"><b>{{ substr($WithholdingTaxDocument->wholesale->textid, 10, 2) }}</b></span>
        <span class="group1"><b>{{ substr($WithholdingTaxDocument->wholesale->textid, 12, 1) }}</b></span>
    </div>
     @else
         <div class="text-customer-tax">
        <!-- สมมติว่า $wholesale->textid = '0125558000987' -->
        <span class="group1"><b>{{ substr($WithholdingTaxDocument->customer->customer_texid, 0, 1) }}</b></span>
        <span class="group2"><b>{{ substr($WithholdingTaxDocument->customer->customer_texid, 1, 4) }}</b></span>
        <span class="group3"><b>{{ substr($WithholdingTaxDocument->customer->customer_texid, 5, 5) }}</b></span>
        <span class="group4"><b>{{ substr($WithholdingTaxDocument->customer->customer_texid, 10, 2) }}</b></span>
        <span class="group1"><b>{{ substr($WithholdingTaxDocument->customer->customer_texid, 12, 1) }}</b></span>
    </div>
     @endif

                ...
                <tr>
                    ...
                    <td style="width: 270px;  text-align: left; vertical-align: top;">
                        ...
                        @if ($paymentModel->payment_method === 'transfer-money')
                            ...
                            วันที่โอน : {{ thaidate('j F Y', $paymentModel->payment_date_time) .' เวลา : '.date('H:i', strtotime($paymentModel->payment_date_time)) }} น.<br>
                        ...
                        @if ($paymentModel->payment_method === 'check')
                            ...
                            วันที่ : {{ thaidate('j F Y', $paymentModel->payment_date_time) .' เวลา : '.date('H:i', strtotime($paymentModel->payment_date_time)) }} น.<br>
                        @endif

...
@section('content')
    <div class="email-app todo-box-container">
        ...
        <form action="{{ route('credit.update',$creditModel->credit_note_id) }}" id="form-create" method="post">
            @csrf
            @method('PUT')
                ...
                <div id="todo-list-container">
                    ...
                    <div class="todo-listing ">
                        <div class="container border bg-white">
                            <h4 class="text-center my-4">แก้ไขใบลดหนี้ / Credit Note</h4>
                                        ...
                                        <div class="col-md-12 ">
                                            <b>Date :</b> <span style="margin: 50px;">
                                                <input type="date" class="date-create" name="credit_note_date"
                                                    value="{{ $creditModel->credit_note_date}}"></span></br>
                                            <b>Credit Note No :</b> <span style="margin: 5px;" class="bg-success">{{$creditModel->credit_note_number}}</span></br>
                                ...
                                <div class="col-6">
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="radio" id="vat-include" name="vat_type"
                                                        value="include" @if ($creditModel->vat_type === 'include') checked @endif>
                                                    <label for="vat-include">คำนวณรวมกับราคาสินค้าและบริการ (VAT
                                                        Include)</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="vat-exclude" name="vat_type"
                                                        value="exclude" @if ($creditModel->vat_type === 'exclude') checked @endif>
                                            ...
                                            <div class="row summary-row">
                                                <div class="col-md-10">
                                                    <input type="checkbox" name="vat_3_status" value="Y"
                                                        id="withholding-tax"
                                                        @if ($creditModel->vat_3_status === 'Y') checked @endif> <span
                                                        class="">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="credit_note_cause"  value="{{$creditModel->credit_note_cause}}"
                                        ...
                                        <div class="col-md-12" style="padding-bottom: 10px">
                                            ...
                                            <textarea name="credit_note_note" class="form-control" cols="30" placeholder="หมายเหตุ" rows="2">{{$creditModel->credit_note_note}}</textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="text-end mt-3">
                                {{-- hidden --}}
                                {{-- รวมเป็นเงิน --}}
                                <input type="hidden" name="total" id="quote-total">
                                {{-- ส่วนลด --}}
                                <input type="hidden" name="discount" id="quote-discount">
                                {{-- ราคาหลังหักส่วนลด --}}
                                <input type="hidden" name="after_discount" id="quote-after-discount">
                                {{-- ราคาไม่รวมภาษีมูลค่าเพิ่ม --}}
                                <input type="hidden" name="price_excluding_vat" id="quote-price-excluding-vat">
                                {{-- จำนวนเงินรวมทั้งสิ้น --}}
                                <input type="hidden" name="grand_total" id="quote-grand-total">
                                ...
                                <input type="hidden" name="invoice_number" value="{{$invoiceModel->invoice_number}}">
                                 ...
                                 {{-- มูลค่าตามใบกำกับภาษีเดิม --}}
                                 <input type="hidden" value="{{ $invoiceModel->invoice_grand_total }}"  name="invoice_grand_total" id="GrandTotalOld">
                                 {{-- มูลค่าที่ถูกต้อง --}}
                                 <input type="hidden" name="grand_total_new" id="grand-total-new-val">
                                  {{-- ผลต่าง --}}

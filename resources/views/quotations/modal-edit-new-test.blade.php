<style>
    ...
    .select2-selection {
        ...
        /* align-items และ align-self ไม่ต้องใส่ */
    }
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-info d-flex align-items-center">
                        <h6 class="card-title text-white">แก้ไขใบเสนอราคา</h6>
                    ...
                    <div class="card-body collapse show">
                        <div class="row table-custom">
                            <div class="col-md-12 position-relative">
                                <label class="form-label small">ชื่อแพคเกจทัวร์:</label>
                                <input type="text" id="tourSearch" class="form-control form-control-sm"
                                    name="quote_tour_name" placeholder="ค้นหาแพคเกจทัวร์...ENTER เพื่อค้นหา" required
                                    autocomplete="off" value="{{ $quotationModel->quote_tour_name ?? '' }}">
                            ...
                            <div class="col-md-4">
                                <label class="form-label small">รหัสทัวร์ API <small
                                        class="text-danger">แก้ไขไม่ได้*</small></label>
                                <input type="text" id="tour-code" name="quote_tour"
                                    class="form-control form-control-sm" value="{{ $quotationModel->quote_tour ?? '' }}"
                                    readonly style="background-color: #81c7844b">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label small">รหัสทัวร์ กำหนดเอง </label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label small">ประเทศที่เดินทาง: </label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label small">สายการบิน:</label>
                            ...
                            <div class="col-md-8">
                                <label class="form-label small">โฮลเซลล์: </label>
                            ...
                            <div class="col-md-12" style="padding-bottom: 10px">
                                ...
                                <textarea name="quote_note" class="form-control" cols="30" rows="1">{{ $quotationModel->quote_note ?? '' }}</textarea>
                            </div>
            ...
            <div class="col-md-6">
                <div class="card shadow">
                    <div class="card-header bg-primary d-flex align-items-center">
                        <h6 class="card-title text-white float-end">เลขที่ใบเสนอราคา
                            #{{ $quotationModel->quote_number }}</h6>
                        <div class="card-actions ms-auto d-flex button-group">
                    ...
                    <div class="card-body collapse show">
                        {{-- <h6 class="">ข้อมูลทั่วไป</h6> --}}
                        <div class="row">

                            <div class="col-md-4">
                                <label class="form-label small">เซลล์ผู้ขายแพคเกจ:</label>
                                <select name="quote_sale" class="form-select select2 form-control-sm" required
                                    style="border: #1976d2 1px solid;">
                            ...
                            <div class="col-md-4">
                                <label class="form-label small">วันที่สั่งซื้อ/จองแพคเกจ:</label>
                            ...
                            <div class="col-md-4">
                                <label class="form-label small">วันที่เสนอราคา</label>
                ...
                <div class="col-lg-12">
                    <div class="card shadow">
                        <div class="card-header bg-light">วันที่เดินทาง</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <label class="form-label small">ระยะเวลาทัวร์ (วัน/คืน): </label>
                                ...
                                <div class="col-md-4 position-relative">
                                    <label class="form-label small">วันออกเดินทาง: <a href="#" class=""
                                            id="list-period"
                                ...
                                <div class="col-md-4">
                                    <label class="form-label small">วันเดินทางกลับ: </label>
        ...
        <div class="container-fluid page-content">
            <div class="todo-listing">
                ...
                <div class="container border bg-white">
                    <h6 class="text-center my-1"><i class="fa fa-file-invoice-dollar"
                            style="color:#1976d2;margin-right:8px;"></i>แก้ไขใบเสนอราคา </h4>

                        <hr class="divider">
                        <div class="section-card">
                            <div class="section-title"
                                style="background:linear-gradient(90deg,#d84315 60%,#ff7043 100%)"><i
                        ...
                        <div class="section-card">
                            <div class="section-title"
                                style="background:linear-gradient(90deg,#43a047 60%,#81c784 100%)">
                            ...
                            <div class="row table-custom">
                                <div class="col-md-3 position-relative">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="customer_name"
                                            id="customerSearch" placeholder="ชื่อลูกค้า...ENTER เพื่อค้นหา" required
                                            aria-describedby="basic-addon1" autocomplete="off"
                                            value="{{ $customer->customer_name ?? '' }}">
                                        <button type="button" class="btn btn-outline-primary btn-sm"
                                            id="btn-new-customer" title="เพิ่มข้อมูลใหม่"><i
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="email" class="form-control" name="customer_email"
                                        placeholder="Email" aria-describedby="basic-addon1" id="customer_email"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="customer_social_id"
                                                    value="{{ $customer->customer_social_id ?? '' }}"
                        ...
                        <hr class="divider">
                        <div class="section-card">
                            <h6 class="section-inline "><i class="fa fa-coins"></i> ข้อมูลค่าบริการ <span
                                    id="pax" class="float-end"></span></h6>
                                ...
                                <div id="discount-list">
                                    ...
                                    @foreach ($quoteProductsDiscount as $row)
                                        <div class="row item-row table-discount mb-1 align-items-center discount-row"
                                            ...
                                            <div class="col-md-1 text-center">
                                                <a href="#"
                                                    class="remove-row-btn text-danger remove-discount-row"><i
                                                        class="fa fa-trash"></i></a>
                        ...
                        <div class="section-card">
                            <div class="section-title"
                                style="background:linear-gradient(90deg,#1976d2 60%,#42a5f5 100%)">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md012">
                                            <label>จำนวนเงินภาษีหัก ณ ที่จ่าย 3% : &nbsp;</label><span
                                                class="text-danger" id="withholding-amount"> 0.00</span> บาท
                                            <hr>
                                        </div>
                                        ...
                                        <div class="summary text-info">
                                            ...
                                            <div class="row summary-row ">
                                                <div class="col-md-10 text-end">ราคาสุทธิสินค้าที่เสียภาษี / Pre-Tax
                                                    Amount:</div>
                                                <div class="col-md-2 text-end"><span id="sum-total-vat">0.00</span>
                                                </div>
                                            </div>
                                            <div class="row summary-row">
                                                <div class="col-md-10 text-end">ส่วนลด / Discount :</div>
                                                <div class="col-md-2 text-end"><span id="sum-discount">0.00</span>
                                                </div>
                                            </div>
                                            <div class="row summary-row">
                                                <div class="col-md-10 text-end">ราคาก่อนภาษีมูลค่าเพิ่ม / Pre-VAT
                                                    Amount:
                                                </div>
                                                <div class="col-md-2 text-end"><span id="sum-pre-vat">0.00</span>
                                                </div>
                                            </div>
                                            <div class="row summary-row">
                                            ...
                                            <div class="row summary-row ">
                                                <div class="col-md-10 text-end">ราคารวมภาษีมูลค่าเพิ่ม / Include VAT:
                                                </div>
                                                <div class="col-md-2 text-end"><span id="sum-include-vat">0.00</span>
                                                </div>
                                            </div>
                                            <div class="row summary-row">
                                                <div class="col-md-10 text-end">จำนวนเงินรวมทั้งสิ้น / Grand Total:
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="quote_payment_type"
                                                id="quote-payment-deposit" value="deposit"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                        id="basic-addon1">ภายในวันที่</span>
                            ...
                            @can('quote.comission')
                                <div class="row mb-3 ">
                                    <div class="col-md-3">
                                        ...
                                        <div>
                                            <input type="radio" name="quote_commission" id="commission-yes"
                                                value="Y"
                                                {{ isset($quotationModel) && $quotationModel->quote_commission == 'Y' ? 'checked' : '' }}>
                                            <label for="commission-yes">จ่ายค่าคอม</label>
                                            <input type="radio" name="quote_commission" id="commission-no"
                                                value="N"

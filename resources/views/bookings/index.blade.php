            ...
            <form action="" method="GET">
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-3 pull-right">
                            <input type="text" class="form-control"
                                placeholder="ค้นหา เลขที่ใบจองทัวร์/รหัสทัวร์/ลูกค้า(ชื่อ)/ลูกค้า(นามสกุล)"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="search_booking_date_range" autocomplete="off"
                            placeholder="เลือกช่วงเวลาการจอง">
                        <input type="hidden" name="search_tour_date_start_created" id="search_tour_date_start_created"
                            value="{{ request('search_tour_date_start_created') }}">
                        <input type="hidden" name="search_tour_date_end_created" id="search_tour_date_end_created"
                    ...
                    <tbody>
                        ...
                        @forelse ($booking as $key => $item)
                            <tr>
                                ...
                                <td>{{ date('d-m-Y', strtotime($item->start_date)) }} ถึง

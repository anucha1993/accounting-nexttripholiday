                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-6">
                                ...
                                <select name="status" class="form-select">
                                    ...
                                    <option value="not_null" {{ request('status') == 'not_null' ? 'selected' : '' }}>
                                        ได้รับแล้ว</option>
                                    <option value="is_null" {{ request('status') == 'is_null' ? 'selected' : '' }}>
                                        ยังไม่ได้รับ</option>
                                </select>
                            </div>
                                ...
                                <select name="wholesale_id" id="" class="form-select select2" style="width: 100%;">
                                    ...
                                    @foreach ($wholesale as $item)
                                        <option value="{{ $item->id }}"
                                            {{ request('wholesale_id') == $item->id ? 'selected' : '' }}>
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        {!! $inputTaxs->withQueryString()->links('pagination::bootstrap-5') !!}
                                ...
                                @forelse ($inputTaxs as $key => $item)
                                    <tr class="">
                                        <td class="text-center fw-bold">
                                            {{ $inputTaxs->total() - ($inputTaxs->firstItem() + $key - 1) }}
                                        </td>
                                        <td>
                                            @if ($item->input_tax_date_tax)
                                        ...
                                        <td>
                                            <small>{!! $item->input_tax_number_tax ?? ' <i class="fas fa-minus"></i>' !!}</small>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-left">{{$item->input_tax_ref}}</td>
                                        <td>
                                            <small>

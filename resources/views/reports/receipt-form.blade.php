                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="column_name" class="form-select">
                                    ...
                                    <option @if($request->column_name === 'payment_number') selected @endif value="payment_number">เลขที่ใบใบเสร็จ</option>
                                    <option @if($request->column_name === 'quote_number') selected @endif value="quote_number">เลขที่ใบเสนอราคา</option>
                            ...
                            <div class="col-md-1">
                                <br>
                                 <a href="{{route('report.receipt')}}"  class="btn  btn-danger float-end ml-2">ล้างการค้นหา</a>
                             </div>
                        </div>

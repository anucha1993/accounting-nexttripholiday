    ...
    <div class="container-fluid page-content">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="card">
                    <div class="card-header bg-info text-white">
                        Quotation No. : <?php echo e($quotationModel->quote_number); ?>

                        <span class="float-end">วันที่ออกใบเสนอราคา :
                            <?php echo e(thaidate('j F Y', $quotationModel->created_at)); ?> เวลา :
                            <?php echo e(date('H:m:s', strtotime($quotationModel->created_at))); ?></span>
                    </div>
                </div>
                                ...
                                <table style="font-size: 12px">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>&nbsp;<?php echo e($customer->customer_texid ? $customer->customer_texid : '-'); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">ชื่อลูกค้า :</td>
                                            <td>&nbsp; คุณ <?php echo e($customer->customer_name); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">ที่อยู่ :</td>
                                            <td>&nbsp; <?php echo e($customer->customer_address ? $customer->customer_address : '-'); ?>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">อีเมล์ :</td>
                                            <td>&nbsp; <?php echo e($customer->customer_email ? $customer->customer_email : '-'); ?>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">เบอร์มือถือ :</td>
                                            <td>&nbsp; <?php echo e($customer->customer_tel ? $customer->customer_tel : '-'); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">เบอร์โทรสาร (Fax) :</td>
                                            <td>&nbsp; <?php echo e($customer->customer_fax ? $customer->customer_fax : '-'); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">ลูกค้าจาก :</td>
                                            <td>&nbsp;
                                                <?php echo e($customer->campaign_source_name ? $customer->campaign_source_name : '-'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;
                                                <?php echo e($customer->customer_social_id ? $customer->customer_social_id : '-'); ?>
                                ...
                                <table style="font-size: 12px">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>&nbsp; <?php echo e($quotationModel->quote_number); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">Booking No. :</td>
                                            <td>&nbsp; <?php echo e($quotationModel->quote_booking); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">วันที่จองทัวร์ :</td>
                                            <td>&nbsp;
                                                <?php echo e($customer->quotationModel ? thaidate('j F Y', $quotationModel->quote_booking_create) : thaidate('j F Y', $quotationModel->quote_booking_create)); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;
                                                <?php echo e($quotationModel->quote_tour ? $quotationModel->quote_tour : $quotationModel->quote_tour_code); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;
                                                <?php echo e($quotationModel->updated_by ? $quotationModel->updated_by : $quotationModel->created_by); ?>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">วันที่แก้ไขล่าสุด :</td>
                                            <td>&nbsp; <?php echo e(date('d/m/Y H:m:s', strtotime($quotationModel->updated_at))); ?>
                                ...
                                <table style="font-size: 12px">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>&nbsp;
                                                <?php echo e($quotationModel->quote_tour_name); ?>

                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">สายการบิน :</td>
                                            <td>&nbsp; <?php echo e($airline->travel_name); ?></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">ช่วงเวลาเดินทาง :</td>
                                            <td>&nbsp;
                                                <?php echo e(thaidate('j F Y', $quotationModel->quote_date_start) . ' -ถึง- ' . thaidate('j F Y', $quotationModel->quote_date_end)); ?>

                                                (<?php echo e($quotationModel->quote_numday); ?>)
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">ผู้เดินทาง (PAX) :</td>
                                            <td>&nbsp;
                                                <?php echo e($quotationModel->quote_pax_total ? $quotationModel->quote_pax_total : '-'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp; <?php echo e($wholesale->wholesale_name_th); ?></td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="align-center" style="font-size: 28px">&nbsp; <b
                                                    class="text-danger"><?php echo e(number_format($quotationModel->quote_grand_total, 2, '.', ',')); ?>

                                                    .-</b></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">จำนวนเงินอักษร :</td>
                                            <td>&nbsp; <span>(<?php echo App\Helpers\BathTextHelper::convert($quotationModel->quote_grand_total); ?>) </span></td>
                                        </tr>
                                        <tr>
                                            <td align="right" class="text-info">กำหนดชำระมัดจำ: :</td>
                                            <td>&nbsp;
                                                <?php if($quotationModel->quote_payment_date): ?>
                                                    <?php echo e(thaidate('j F Y', $quotationModel->quote_payment_date) . ' ก่อนเวลา ' . date('H:m', strtotime($quotationModel->quote_payment_date)) . ' น.'); ?>

                                                    &nbsp;
                                                    <?php echo e('จำนวนเงิน :' . number_format($quotationModel->quote_payment_total, 2, '.', ',') . '.-'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>&nbsp;
                                                <?php echo e(thaidate('j F Y', $quotationModel->quote_payment_date_full) . ' ก่อนเวลา ' . date('H:m', strtotime($quotationModel->quote_payment_date_full)) . ' น.'); ?>

                                                &nbsp;
                                                <?php echo e('จำนวนเงิน :' . number_format($quotationModel->quote_payment_total_full, 2, '.', ',') . '.-'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo getQuoteStatusPayment($quotationModel); ?>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <a href="<?php echo e(route('quote.modalEditCopy', $quotationModel->quote_id)); ?>"
                        ...
                        <a href="<?php echo e(route('payment.quotation', $quotationModel->quote_id)); ?>"
                        ...
                        <a href="<?php echo e(route('paymentWholesale.quote', $quotationModel->quote_id)); ?>"
                        ...
                        <a href="<?php echo e(route('inputtax.createWholesale', $quotationModel->quote_id)); ?>"
                        ...
                        ?>
                        <a href="<?php echo e(route('quotationView.index', $encryptedId)); ?>" id="shareLinkButton"
                        ...
                        <a href="<?php echo e(route('quoteLog.index', $quotationModel->quote_id)); ?>"
                        ...
                        <a href="<?php echo e(route('inputtax.inputtaxCreateWholesale', $quotationModel->quote_id)); ?>"
                    ...
                    ?>
                        ...
                        <hr/>
                        <span class="float-end"> ยอดรวมต้นทุนโฮลเซลล์: <?php echo e(number_format($GetDepositWholesale+$quotationModel->inputtaxTotalWholesale() - $wholesalePayment, 2)); ?></span><br>
                        <span class="float-end"> ชำระเงินโฮลเซลล์แล้ว: <?php echo e(number_format($wholesalePayment, 2)); ?></span><br>
                        <span class="float-end"> ค้างชำระเงินโฮลเซลล์: <?php echo e(number_format($quotationModel->inputtaxTotalWholesale() - $wholesalePayment, 2)); ?></span><br>
                        <span class="float-end"> ลูกค้าชำระแล้ว :  <?php echo e(number_format($quotationModel->GetDeposit(), 2)); ?> </span><br>
                        <span class="float-end"> กำไร : <?php echo e($wholesalePayment <= 0 ?  0.00 : number_format($TotalPayment, 2)); ?></span><br>      
                        <span class="float-end"> ต้นทุนอื่นๆ : <?php echo e(number_format($paymentInputtaxTotal+$quotationModel->getTotalInputTaxVatType(), 2)); ?> </span><br>         
                        <span class="float-end"> กำไรสุทธิ:  <?php echo e($wholesalePayment <= 0 ?  0.00 : number_format($TotalGrand, 2)); ?> </span><br>
        ...
        <script>
            $(document).ready(function() {
                ...
                var quoteId = "<?php echo e($quotationModel->quote_id); ?>"

                function quoteEdit(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('quote.editAjax', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                ...
                function paymentTable(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('payments', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                        success: function(response) {
                ...
                function paymentWholesale(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('wholesale.payment', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                        success: function(response) {
                ...
                function files(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('quotefile.index', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                        success: function(response) {
                ...
                function inputtax(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('inputtax.table', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                        success: function(response) {
                ...
                function inputtaxWholesale(quoteId) {
                    // โหลดเนื้อหาของไฟล์ฟอร์มและแสดงใน DOM
                    $.ajax({
                        url: "<?php echo e(route('inputtax.tableWholesale', '')); ?>/" + quoteId, // ประกอบ URL แบบถูกต้อง
                        type: 'GET',
                        success: function(response) {
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/accounting-nexttripholiday/resources/views/quotations/form-edit-new.blade.php ENDPATH**/ ?>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <?php echo $__env->make('notifications.dropdown', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script type="text/javascript" src="https://cdn.datatables.net/buttons/2.2.2/js/buttons.print.min.js"></script>
    ...
    <script>
        ...
        var notificationRoutes = {
            getRecent: "<?php echo e(route('notifications.api.recent')); ?>",
            markAsRead: "<?php echo e(route('notifications.mark-as-read', 'ID_PLACEHOLDER')); ?>".replace('ID_PLACEHOLDER', ''),
            markAllAsRead: "<?php echo e(route('notifications.api.mark-all-as-read')); ?>"
        };
    </script>

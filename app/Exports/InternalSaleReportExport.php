...
class InternalSaleReportExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    protected $data;
    protected $mode;
    protected $runNo = 0;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('A1:T' . ($this->data->count() + 1))->applyFromArray([
            'borders' => [
                'allBorders' => [
    ...
    public function columnWidths(): array
    {
        return [
            ...
            'L' => 15, // ส่วนลด
            'M' => 15, // ยอดรวมสุทธิ
            'N' => 20, // ยอดชำระโฮลเซลล์
            'O' => 15, // ต้นทุนอื่นๆ
            'P' => 15, // ต้นทุนรวม
            'Q' => 15, // กำไร
            'R' => 15, // กำไรเฉลี่ย:คน
            'S' => 20, // คอมมิชชั่นทั้งสิ้น
            'T' => 30, // CommissionGroup
        ];
    }
}

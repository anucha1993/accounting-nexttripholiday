...
class dibitController extends Controller
{
    //
    ...
    public function create(invoiceModel $invoiceModel, Request $request)
    {
        ...
        $sale = saleModel::where('id',$invoiceModel->quote_sale)->first();
        ...
        //dd($quoteProducts);
        return view('invoices.form-create',compact('invoiceModel','customer','sale','tour','airline','products'));
    }

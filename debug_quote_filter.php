...
use App\Models\InputTaxVat;
use App\CustomHelpers\Helper;
...
$inputTaxVat = InputTaxVat::where('quotation_id', $quote->quote_id)->first();
...
$statusBadge = Helper::getStatusWhosaleInputTax($quote->quote_id);
